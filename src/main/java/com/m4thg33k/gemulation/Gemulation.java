...
@Mod(modid = Gemulation.MODID,name = Gemulation.MODNAME, version = Gemulation.VERSION, dependencies = "required-after:SilentGems@[2.0.4-alpha,);required-after:lit@[1.0.11,)")
